...
export default function Background() {
  ...
  return (
    <>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full hero-gradient overflow-hidden"></div>

      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full hero-gradient overflow-hidden">
        <svg
          ...
          <g clipPath="url(#clip0_1182_6)">
            ...
            <g filter="url(#filter0_d_1182_6)">
              <path
                d="M337 452.5L350 320.5L236.5 469L337 452.5Z"
                fill="url(#paint1_linear_1182_6)"
              />
              <path
            ...
            <g
              ...
              <path
                d="M298 155.5L564.5 144.5L97 256L298 155.5Z"
                fill="url(#paint14_linear_1182_6)"
              />
            ...
            <g filter="url(#filter18_d_1182_6)">
              <path
            ...
            <motion.g filter="url(#filter21_d_1182_6)">
              <path
                d="M83.5 524L187 394.5L143.5 713L83.5 524Z"
                fill="url(#paint65_linear_1182_6)"
              />
              <path
                d="M83.5 524L187 394.5L-109 507.5L83.5 524Z"
                fill="url(#paint66_linear_1182_6)"
              />
              <path
                d="M83.5 524L143.5 713L-109 507.5L83.5 524Z"
                fill="url(#paint67_linear_1182_6)"
              />
            </motion.g>
            <g
          ...
          <defs>
            ...
            <linearGradient
              ...
              <stop offset="1" stop-color="#F89700" />
            </linearGradient>
            <linearGradient
